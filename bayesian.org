...
(docker/start-sbcl-with-sly "bayesian-analysis" "deepestthought42/sbcl-1.3.15-bayesian-analysis:20170517"
...
(labels ((cmd (fmt-str &rest args)
  ...
  (mgl-gnuplot:with-session ()
    ...
    (cmd "set terminal wxt enhanced font 'Georgia,8' dashed")
;    (cmd "set logscale x")
    (let ((d (ba::laplacian-approximation *res* 'fp::rho-m0 100)))
     (mgl-gnuplot:plot*
      (list
