...
(let ((params (fp:get-init-params-from-midas-file
	       ,*test-file* 4d0
	       :om-c-prior (make-instance 'ba:gaussian-prior :mu 3.222544d7 :sigma 10d0)
	       :tof-offset-prior :jeffreys
	       :rho-m0 4d-4
	       :rho-m0-min 1d-4
	       :rho-m0-max 1d-3)))
  (defparameter *res*
    (ba:find-optimum (make-instance 'ba:nlopt :algorithm nlopt:+nlopt_ln_neldermead+)
